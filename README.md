...
そこで、他の旅行者と発見したを共有して、旅先で周辺で過去に発見されたことを知ることにより、旅に行かなかないと調べようともしなかったことに気づき、旅の道中での体験を増やすことができるのではないかと考えました。
さらに、海外での治安情報など、あまり調べられない情報があります。例えばエリア全体は比較的安全だが、この路地は危険、などということもあります。旅行者目線でこのような危険情報を共有することにより、旅先での安全性の向上につながるのではないかと考えました。
### 製品説明（具体的な製品の説明）
* マップ上に他ユーザーの投稿を表示
* 投稿には「風景」「グルメ」「危険情報」などのタグ付け
* GPSを利用した位置情報連動
* 自分の発見をコメント・画像で簡単に投稿・共有
* 他ユーザーの投稿にGoodボタンでリアクションできる。
### 特長
#### 1. 旅先でのリアルタイム発見共有 「あ、ここいいかも！」を瞬時に他の旅行者に伝えられる。
#### 2. タグで簡単に情報整理    風景・グルメ・危険情報など、投稿内容をわかりやすく分類。
