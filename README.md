...
そこで他の旅行者と、さまざまな発見を共有することにより、旅の道中での体験を増やすことができるのではないかと考えました。
また、海外での治安情報など、一般的な情報サイトでは十分に調べられない内容を補うことも期待できます。たとえば、「エリア全体は比較的安全だが、この路地は危険」といった、より細かな現地情報です。旅行者の視点からこのような危険情報を共有することで、旅先での安全性向上にもつながるのではないかと考え、今回のプロダクトに活かしました。
### 製品説明（具体的な製品の説明）
* マップ上に他ユーザーの投稿を表示
